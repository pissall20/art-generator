...
Create generative art by using the canvas api and node js. Before you use the generation engine, make sure you have node.js installed. This repo is forked from [Hashlips Art Engine](https://github.com/HashLips/hashlips_art_engine)
...
```sh
git clone https://github.com/pissall20/art-generator.git
```
